...
{
	private final BlockListSetting blockList = new BlockListSetting("Block",
		"The type of block to search for.", "minecraft:diamond_ore");
	private String lastBlockListSignature;
	...
	{
		return getName() + " [" + blockList.size() + " blocks]";
	}
	
	@Override
	protected void onEnable()
	{
		lastBlockListSignature = blockList.getSignature();
		coordinator.setTargetBlocks(blockList.getBlocks());
	...
	public void onUpdate()
	{
		...
		String currentSignature = blockList.getSignature();
		if(!Objects.equals(currentSignature, lastBlockListSignature))
		{
			lastBlockListSignature = currentSignature;
			coordinator.setTargetBlocks(blockList.getBlocks());
