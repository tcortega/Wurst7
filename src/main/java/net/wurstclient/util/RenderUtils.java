...
public enum RenderUtils {
    ...
    public static void drawEntity(DrawContext context, EntityType<?> entityType, int x, int y, int size, float mouseX,
                                  float mouseY) {
        MinecraftClient mc = MinecraftClient.getInstance();
        if (mc.world == null || entityType == null) {
            return;
        }
        ...
        InventoryScreen.drawEntity(context, x, y, size, mouseX, mouseY, livingEntity);
    }
}
