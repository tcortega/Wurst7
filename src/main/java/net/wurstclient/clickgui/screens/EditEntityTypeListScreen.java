...
public final class EditEntityTypeListScreen extends Screen
{
	...
	public EditEntityTypeListScreen(Screen prevScreen,
		EntityTypeListSetting entityList)
	{
		super(Text.literal(""));
		...
		float partialTicks)
	{
		...
		if(entityToAdd != null)
		{
			RenderUtils.drawEntity(context, entityToAdd, width / 2 - 188,
				height - 27, 12, 0, 0);
		}else
		{
			RenderUtils.drawItem(context, ItemStack.EMPTY, width / 2 - 164,
				height - 52, false);
		}
	...
	private static class ListGui extends ListWidget
	{
			...
			int var4, int mouseX, int mouseY, float partialTicks)
		{
			...
			if(entityType != null)
			{
				RenderUtils.drawEntity(context, entityType, x + 10, y + 27, 10,
					0, 0);
			...
			context.drawText(tr,
				"ID: " + EntityType.getId(entityType).toString(), x + 28,
				y + 18, 0xa0a0a0, false);
		}
